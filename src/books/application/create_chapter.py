...
from books.entities.core.book.book import book_with_new_chapter
from books.entities.core.book.chapter_number import ChapterNumber


@dataclass(frozen=True)
class CreateChapter[SignedAccessTokenT]:
    ...
    async def __call__(
        ...
        async with self.transaction:
            ...
            book_with_new_chapter_ = book_with_new_chapter(
                book, access_token, chapter_number, chapter_text, current_time
            )

            await self.map(book_with_new_chapter_)
