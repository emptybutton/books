...
from books.entities.core.user import (
    registered_user,
)
...
class RegisterUser[SignedUserIDT, UserViewT, UserViewWithIDT]:
    ...
    async def __call__(
        ...
        """
        :raises books.application.register_user.RegisteredUserToRegisterUserError:
        :raises books.application.register_user.TakenUserNameToRegisterUserError:
        """  # noqa: E501
