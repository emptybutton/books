...
from books.infrastructure.telethon.in_telegram.message_queque import (
    InTelegramMessageQueque,
)
from books.infrastructure.telethon.in_telegram.primitive import (
    InTelegramPrimitive,
)
from books.infrastructure.telethon.in_telegram.row_heap import InTelegramRowHeap
...
from books.infrastructure.telethon.transaction import (
    AsyncTransactionResults,
    Transaction,
    TransactionResult,
)
from books.infrastructure.telethon.transaction_mark import (
    TransactionState,
...
async def replicated_telegram_heap_from_telegram_log(
    ...
    async_transaction_results: AsyncTransactionResults,
) -> NoReturn:
    ...
    async for message in log:
        ...
        if specified_transaction_state is TransactionState.started:
            ...
            del active_transaction_by_id[transaction_id]
            async_transaction_results[transaction_id] = result
